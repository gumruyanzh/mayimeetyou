  ...
  return (
    <div className="space-y-3">
      <button
        ...
        disabled={loading}
        className="w-full bg-text-primary hover:opacity-90 text-bg py-3 px-4 rounded-xl font-semibold transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
      >
        {loading ? (
          'Generating...'
        ) : (
      ...
      <div className="bg-surface-alt border border-border p-3 rounded-xl">
